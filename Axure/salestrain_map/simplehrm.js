...
{  
	 ...
	 clickSize[1] = jQuery(evt.srcElement).offset().top;
		...
		else
		{
			...
			else if(result.indexOf("imageid=")!=-1)
			{
				...
				else
				{
					...
					{
						M("resourceimg").src="/images/messageimages/temp/man.png";
					}
					else
					{
						M("resourceimg").src="/images/messageimages/temp/women.png";
					}
			...
			else if(result.indexOf("ip=")!=-1)
			{
				...
				if(isonline == ',')
				{
					M("isonline").src = "/images/messageimages/temp/offline.png";
					if(language==7||language==9)
					{
						M("isonline").title = "离线";
					}
				...
				{
					M("isonline").src = "/images/messageimages/temp/online.png";
					if(language==7||language==9)
					{
						M("isonline").title = "在线";
					}
...
function showIframe(div,hi,wi){
   ...
   oIframe.style.width = 460+"px"; 
   oIframe.style.height = 293+"px";
